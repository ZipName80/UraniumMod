...
package net.mcreator.uraniummod.block;
...
public class UraniumOreBlock extends UraniummodModElements.ModElement {
	@ObjectHolder("uraniummod:uranium_ore")
	public static final Block block = null;
	public UraniumOreBlock(UraniummodModElements instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(UraniumTabItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
